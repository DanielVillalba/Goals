...
FROM            dbo.TrainingProgram INNER JOIN
                         ...
                         dbo.Resource ON dbo.TrainingProgramVisits.ResourceId = dbo.Resource.ResourceId INNER JOIN
                         dbo.TrainingProgramCategory ON dbo.TrainingProgramCategory.IdTrainingProgramCategory = dbo.TrainingProgram.Category
GROUP BY dbo.TrainingProgram.Name, dbo.Resource.Name, dbo.TrainingProgramVisits.VisitDate, dbo.TrainingProgramCategory.Name
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'TrainingProgramVisitsView';
