<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyReport.aspx.cs" Inherits="CDPTrackerSite.Reporting.MonthlyReport" %>
...
<form id="form1" runat="server">
    ...
    <div id="main" align="left">
        <rsweb:ReportViewer ID="report" Style="width: 100%;" runat="server"
            ...
            <LocalReport ReportPath="Reporting/MonthlyReport.rdlc">
            </LocalReport>  
        </rsweb:ReportViewer>
    </div>
</form>
