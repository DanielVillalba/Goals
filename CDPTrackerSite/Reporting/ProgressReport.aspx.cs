...
#endif
    public partial class ProgressReport : ProgressReportBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //// check who is active in ActiveDirectory
                
                //foreach (var datauser1 in updatedData) {

                //    try
                //    {

                //        bool es = employeeActiveDirectoryManager.IsEnabled(datauser1.Name);
                //        if (!es) throw new ArgumentException("The user does not exist.");
                ...
                report.LocalReport.ReportPath = Server.MapPath("~/Reporting/ProgressReport.rdlc");
