<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgressReport.aspx.cs" Inherits="CDPTrackerSite.Reporting.ProgressReport" %>
...
<form id="form1" runat="server">
    ...
    <div id="main" align="left">
        <rsweb:ReportViewer ID="report" Style="width: 100%;" runat="server"
            ...
            Visible="True" ProcessingMode="Local" PageCountMode="Actual" InternalBorderColor="#CCCCCC" BackColor="#ECE9D8" DocumentMapWidth="25%">
            <LocalReport ReportPath="Reporting/ProgressReport.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
</form>
