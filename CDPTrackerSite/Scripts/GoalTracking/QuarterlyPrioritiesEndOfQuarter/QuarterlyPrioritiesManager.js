...
var QuarterlyPrioritiesManager = function (
    ...
    self.init = function () {        
        ...
        if (config.quarterlyPriorityId % 1 === 0 && config.quarterlyPriorityId > 0) {
            IS_NEW_REGISTRY = false;
        }
       // console.debug("",config.one)
    ...
    function getQuarterlyPrioritiesData() {
        ...
        try {
            ...
            data.cycle_comments = cycleCommentsContainer.getListData();
    ...
    function validateData(data) {
        ...
        messages = moduleValidateData(messages, cycleCommentsContainer, data.cycle_comments);
